                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors {{ $item['isSelected'] ? 'bg-indigo-50/20 dark:bg-indigo-900/10' : '' }}">
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <button type="button" 
                                                    ...
                                                    class="px-3 py-1.5 text-xs font-bold rounded-xl border border-indigo-200 text-indigo-700 bg-indigo-50 hover:bg-indigo-100 transition-colors {{ $item['isSelected'] ? '' : 'opacity-50 cursor-not-allowed' }}"
                                                    {{ !$item['isSelected'] ? 'disabled' : '' }}>
