        ...
        x-data="{ 
            ...
            init() {
                console.log('🔵 LoginWarehouseSelector Modal inicializado', {
                    ...
                    warehousesCount: @js(count($warehouses)),
                    selectedStoreId: @js($selectedStoreId),
                    selectedWarehouseId: @js($selectedWarehouseId)
                });
                    ...
                    @if(count($warehouses) > 0)
                        <div>
                            <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">
                                Sucursales y Bodegas Disponibles
                            </h4>
                            <div class="space-y-6 max-h-96 overflow-y-auto pr-2">
                                @foreach($warehouses as $warehouse)
                                    ...
                                    <div class="border-l-4 border-indigo-500 pl-4">
                                        ...
                                        <!-- Stores for this Warehouse -->
                                        <div class="space-y-2 ml-2">
                                            @foreach($warehouse['stores'] as $store)
                                                <button
                                                    type="button"
                                                    wire:click="selectStore({{ $store['id'] }}, {{ $warehouse['id'] }})"
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-2 text-sm text-gray-400 dark:text-gray-500">
                                No se encontraron sucursales activas para tu compañía
                            </p>
                        </div>
                    @endif
                </div>
