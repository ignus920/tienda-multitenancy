                                ...
                                <div class="flex gap-2 shrink-0 ml-4">
                                    @if($task->status === 'pendiente')
                                        <div class="relative flex items-center gap-2" x-data="{ showReassign: false, showComplete: false }">
                                            ...
                                            <div x-show="showReassign" x-cloak class="absolute bottom-full mb-1 left-0 w-32 p-1 bg-gray-800 text-white text-2xs text-center rounded shadow-lg z-10" style="display: none;">Reasignar a otro</div>
                                            ...
                                            <div x-show="showComplete" x-cloak class="absolute bottom-full mb-1 right-0 w-32 p-1 bg-gray-800 text-white text-2xs text-center rounded shadow-lg z-10" style="display: none;">Marcar como lista</div>
                                        </div>
                                    @endif
                                </div>
                            </div>
