                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <button type="button"
                                                ...
                                                <span class="inline-block h-3 w-3 transform rounded-full bg-white shadow-sm transition-all duration-200 ease-in-out {{ $ut->status ? 'translate-x-4' : 'translate-x-1' }}"></span>
                                            </button>
                                        </div>
                                    </div>
                                </td>
