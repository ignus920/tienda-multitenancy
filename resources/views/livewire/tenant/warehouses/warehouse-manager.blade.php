    ...
    <div class="max-w-12xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Gestión de Sucursales</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Administración de sucursales del sistema</p>
                </div>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                                {{ $warehouse->company->businessName ?? trim($warehouse->company->firstName . ' ' . $warehouse->company->lastName) ?? 'N/A' }}
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">
                                {{ $warehouse->address }}
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                ...
                                <div class="flex items-center justify-center">
                                    <button type="button"
                                        ...
                                        aria-label="Toggle warehouse status for {{ $warehouse->name }}">
                                        <span class="inline-block h-4 w-4 transform rounded-full bg-white shadow-sm transition-all duration-200 ease-in-out {{ $warehouse->status ? 'translate-x-5' : 'translate-x-1' }}"></span>
                                    </button>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400 text-lg font-medium">No se encontraron sucursales</p>
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                {{ $editingId ? 'Actualiza la información de la sucursal' : 'Completa los datos para crear una nueva sucursal' }}
                            </p>
                        </div>
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div>
                                    ...
                                    <select wire:model="companyId"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('companyId') border-red-500 @enderror">
                                        <option value="">Seleccionar empresa</option>
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}">
                                                {{ $company->businessName ?: trim($company->firstName . ' ' . $company->lastName) }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('companyId')
                                ...
                                <div>
                                    ...
                                    <input wire:model="address" type="text"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('address') border-red-500 @enderror"
                                ...
                                <div>
                                    ...
                                    <input wire:model="postcode" type="text"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('postcode') border-red-500 @enderror"
