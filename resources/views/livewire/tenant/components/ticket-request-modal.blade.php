...
<div x-data="{
    ...
    initQuill() {
        ...
        // de texto) y revienta el guardado con "Data too long for column
        // detail". Se bloquea el pegado de imágenes aquí a propósito.
                            ...
                            <table class="w-full text-left text-xs">
                                <thead class="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                                    <tr>
                                        ...
                                        <th class="px-3 py-3 font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Depto. / Prov.</th>
