    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6">
            ...
            <div class="mb-6">
                ...
                @else
                <a href="{{ route('tenant.remissions') }}" class="inline-flex items-center text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 font-medium">
