                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button wire:click="confirmItemDeletion({{ $br->id }})"
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto"
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                        {{ $brand_id ? 'Editar Categoria' : 'Crear Categoría' }}
                    </h3>
                </div>
                ...
                <form wire:submit.prevent="save" class="p-6 space-y-6">
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <button type="submit" class="px-3 py-1 bg-indigo-600 text-white rounded">{{ $brand_id ? 'Actualizar' : 'Crear' }}</button>
                    </div>
                </form>
            </div>
        </div>
