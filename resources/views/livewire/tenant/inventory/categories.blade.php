                                ...
                                <td class="px-6 py-3 whitespace-nowrap text-center  text-sm font-medium text-gray-900 dark:text-white">
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="flex items-center space-x-3">
                                            <!-- Toggle Switch -->
                                            <button type="button"
                                                wire:click="toggleCategoryStatus({{ $ct->id }})"
                                                ...
                                                role="switch"
                                                aria-checked="{{ $ct->status ? 'true' : 'false' }}"
                                                aria-label="Toggle company status">
                                                <span class="inline-block h-3 w-3 transform rounded-full bg-white shadow-sm transition-all duration-200 ease-in-out {{ $ct->status ? 'translate-x-4' : 'translate-x-1' }}"></span>
                                            </button>
                                        </div>
                                    </div>
                                </td>
