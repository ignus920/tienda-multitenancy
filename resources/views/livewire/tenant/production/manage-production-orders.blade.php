                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('production.orders.pdf', $order->id) }}" target="_blank"
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto"
        ...
        <div class="relative z-10 bg-white dark:bg-gray-800 rounded-xl shadow-2xl ring-1 ring-black/10 dark:ring-white/10 w-full max-w-2xl max-h-[92vh] overflow-y-auto my-auto"
            ...
            <form wire:submit.prevent="saveProcessStage" class="p-6 space-y-6">
                ...
                {{-- ── Error de stock ── --}}
                @if($processModalError)
                <div class="flex items-start gap-3 px-4 py-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                    <x-heroicon-o-exclamation-triangle class="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                    <p class="text-sm text-red-700 dark:text-red-400">{{ $processModalError }}</p>
                </div>
                @endif
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <input type="number" min="0.001" step="0.001"
                                ...
                                placeholder="Cant."
                                class="w-24 flex-shrink-0 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
                            {{-- Unidad de medida --}}
                            <select wire:model="materialConsumptions.{{ $index }}.unit_measurement"
                                class="w-32 flex-shrink-0 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
