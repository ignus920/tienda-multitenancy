            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto"
                ...
                <form wire:submit="save" class="p-6 space-y-6">
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="businessName" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Razon Social *</label>
                        ...
                        <!-- Codigo CIIU -->
                        <div>
                            <label for="code_ciiu" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Codigo CIIU</label>
                        ...
                        <div class="md:col-span-2">
                            <label for="warehouseAddress" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Direccion de Facturacion</label>
                            ...
                            <div class="flex items-center gap-3 p-4 rounded-lg
                                ...
                                <label for="createUser" class="text-sm font-medium flex-1 {{ empty($billingEmail) || $emailExists || $hasExistingUser ? 'text-gray-400 dark:text-gray-600' : 'text-gray-700 dark:text-gray-300' }}">
                                    ...
                                    <p class="text-xs mt-1 {{ empty($billingEmail) || $emailExists || $hasExistingUser ? 'text-gray-400 dark:text-gray-600' : 'text-gray-600 dark:text-gray-400' }}">
                                        ...
                                        @else
                                        Crear automáticamente un usuario para acceder al sistema con perfil de {{ ucfirst(strtolower($type ?: 'Cliente')) }}
                                        @endif
                                    </p>
                                </label>
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto"
                ...
                <form wire:submit="save" class="p-6 space-y-6">
                    <div class="space-y-6">
                        ...
                        <!-- Vendedor Asignado (Modal) -->
                        <div>
                            <label for="seller_id_modal" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Vendedor Asignado *</label>
                            <select wire:model="seller_id" id="seller_id_modal" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" required>
