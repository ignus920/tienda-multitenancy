            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row gap-4 justify-between items-center">
                ...
                <div class="w-full md:w-56 shrink-0">
                    <select wire:model.live="searchAssignedToId" 
                        class="block w-full py-2 pl-3 pr-8 border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm font-medium">
                        <option value="">Dirigido a...</option>
                        @foreach($usersWithAssignedProjects as $user)
                            <option value="{{ $user->id }}">{{ Str::limit($user->name, 25) }}</option>
                        @endforeach
                    </select>
                </div>

                <!-- Pestañas (Tabs) -->
                <div class="flex bg-gray-100 dark:bg-gray-900 p-1 rounded-lg text-xs font-semibold self-stretch md:self-auto shrink-0">
    ...
    <div class="fixed inset-0 bg-gray-500/75 dark:bg-gray-900/80 backdrop-blur-xs flex items-center justify-center p-4 z-50">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 max-w-lg w-full overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-3">
                ...
                <button wire:click="createProject" type="button" wire:loading.attr="disabled"
