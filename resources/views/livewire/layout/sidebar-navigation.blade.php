    ...
    <nav class="flex flex-1 flex-col p-4 space-y-1">
        ...
        <div x-data="{ tooltip: false, open: false }" class="w-full">
            ...
            <div
                ...
                <span x-show="!sidebarCollapsed" class="ml-3 flex-1"  x-transition>Inventario</span>
            ...
            <!-- Submenú (para sidebar expandido) -->
            <div x-show="open && !sidebarCollapsed" x-transition class="ml-8 mt-1 space-y-1 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div x-show="sidebarCollapsed && tooltip" x-transition class="absolute left-full ml-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded shadow-lg z-50 py-1 whitespace-nowrap"
                @mouseenter="tooltip = true"
                @mouseleave="tooltip = false">
                <a href="{{url('/items/items')}}" class="block px-2 py-1 hover:bg-gray-700 dark:hover:bg-gray-600">Ítems</a>
                <a href="{{url('/inventory/categories')}}" class="block px-2 py-1 hover:bg-gray-700 dark:hover:bg-gray-600">Categorías</a>
                <a href="{{url('/inventory/commands')}}" class="block px-2 py-1 hover:bg-gray-700 dark:hover:bg-gray-600">Comandas</a>
                <a href="{{url('/inventory/brands')}}" class="block px-2 py-1 hover:bg-gray-700 dark:hover:bg-gray-600">Marcas</a>
                <a href="{{url('/inventory/houses')}}" class="block px-2 py-1 hover:bg-gray-700 dark:hover:bg-gray-600">Casas</a>
                <a href="{{url('/inventory/units')}}" class="block px-2 py-1 hover:bg-gray-700 dark:hover:bg-gray-600">Unidades de Medida</a>
            </div>
        </div>

        <!-- Caja -->
        <a href="{{ route('petty-cash.petty-cash') }}"
           class="group flex items-center rounded-lg px-3 py-2.5 text-sm font-medium transition-all duration-200 {{ request()->routeIs('customers.*') ? 'bg-indigo-50 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 border-r-2 border-indigo-500' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-indigo-600 dark:hover:text-indigo-400' }}"
           :class="sidebarCollapsed ? 'justify-center' : 'justify-start'"
           x-data="{ tooltip: false }"
           @mouseenter="tooltip = sidebarCollapsed"
