    ...
    <div class="max-w-12xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Botones</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Gestión de botones</p>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-900">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Vínculo</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Módulo</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                @php
                                    $buttonClasses = match(strtolower($item->color)) {
                                ...
                                <a href="{{ $item->link }}" target="_blank" rel="noopener noreferrer"
                                    class="{{ $buttonClasses }} inline-block px-4 py-2 rounded-lg text-xs font-semibold uppercase tracking-wider transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2">
                                    {{ $item->tittle }}
                                </a>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                ...
                                <div x-data="{ open: false }" @click.outside="open = false" class="relative inline-block text-left static">
                ...
                <form wire:submit="save" class="p-6 space-y-6">
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select wire:model="modul_id"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="">Selecciona un modulo</option>
                                <option value="products">Ventas</option>
                                <option value="items">Productos</option>
                                <option value="imports">Importaciones</option>
                                <option value="remissions">Orden remisiones</option>
                                <option value="quoter">Cotizaciones</option>
                        ...
                        <div>
                            ...
                            <input wire:model="link"
                                type="text"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                placeholder="Ingresa el vinculo">
                            @error('link')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
