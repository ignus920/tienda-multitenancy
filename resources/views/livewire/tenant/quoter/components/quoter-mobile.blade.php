                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center gap-2">
                            ...
                            <button
                                wire:click="editarCotizacion({{ $quote->id }})"
                                class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2">
