<div>
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $instructivo->title }}</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $instructivo->department->name }}</p>
            </div>
        </div>
        @if($canManage)
        <button wire:click="openNewEntry" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors">
