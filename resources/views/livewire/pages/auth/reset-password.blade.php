...
<div class="w-full max-w-[90%] sm:max-w-[60%] mx-auto px-4 sm:px-6 lg:px-8 mt-[10vh]">

     <h3 class="text-2xl font-bold text-gray-900 mb-6 text-center">Recuperar contraseña</h3>
    <form wire:submit="resetPassword" class="space-y-6">
        ...
        <div class="mt-6" x-data="{ showPassword: false }">
            ...
            <div class="relative">
                ...
                <button 
                    ...
                    class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 rounded"
        ...
        <!-- Confirm Password -->
        <div class="mt-6" x-data="{ showPasswordConfirmation: false }">
